...
const DEFAULT_WALLET_VERSION = 'v4R2'; // v4R2 is the latest version of wallet contract
//const DEFAULT_WALLET_VERSION = 'v5R1'; // V5R1 is the latest version of wallet contract with support for Jettons and other features
...
class Controller {
    ...
    getApiKey(isTestnet) {
        const webApiKey = isTestnet
            ? '2719bbe6d3d88b8025db8791a4d7e034ad2a6bb977cd6c2d9aa2c86468235296'
            : '2719bbe6d3d88b8025db8791a4d7e034ad2a6bb977cd6c2d9aa2c86468235296';
      ...
      return new Promise(async (resolve) => {
        ...
        this.ton = new TonWeb(
          new TonWeb.HttpProvider(this.isTestnet ? testnetRpc : mainnetRpc, {
            apiKey: this.getApiKey(this.isTestnet),
          })
        );

        this.myAddress = await storage.getItem("address");
        if (this.myAddress) {
          this.myAddress = new TonWeb.utils.Address(this.myAddress).toString(
            true,
            true,
            false,
            this.isTestnet
